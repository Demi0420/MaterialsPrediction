...
class CGCNNStructureDataset(Dataset):
    def __init__(self, 
        ...
        self.extra_feature_cols = [
            ...
            "dielectric_constant", "refractive_index", "stoichiometry_sum"
        ]
...
def main_training_example(
    ...
    for epoch in range(1, EPOCH_NUM + 1):
        ...
        if early_stop_counter == 0:
            _ = predict_test_set(model, val_loader, output_csv=f"val_epoch{epoch}_pred.csv")
...
if __name__ == '__main__':
    ...
    df_allowed = pd.read_csv("data_e43.csv")
